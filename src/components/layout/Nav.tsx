...
export default function Nav({ theme, onThemeChange }: NavProps) {
  return (
    <header className="sticky top-0 inset-x-0 z-50 bg-ivory/95 backdrop-blur border-b border-ink/15">
      <div className="max-w-zine mx-auto flex items-center justify-between gap-2 px-4 py-3 sm:gap-4 sm:px-5 md:px-10">
        <a
          href="#top"
          className="flex min-h-11 items-center whitespace-nowrap font-display text-base text-ink lowercase sm:text-lg md:text-xl"
        >
          bear&rsquo;s bakery
        </a>
        ...
        <a
          ...
          className="inline-flex min-h-11 w-11 items-center justify-center gap-2 rounded-md bg-ink px-3 text-sm font-serif italic text-ivory transition-colors hover:bg-umber sm:w-auto sm:px-3.5 md:px-4"
